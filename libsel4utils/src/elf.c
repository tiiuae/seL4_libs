 ...
 */
static inline seL4_CapRights_t rights_from_elf(
 ...
 * @return 0 on success.
 */
static int create_reservations(
    vspace_t *loadee,
 ...
 * @return 0 on success.
 */
static int cap_writes_check_move_frame(
    seL4_CapRights_t a,
    seL4_CapRights_t b,
    bool *result)
{
 ...
 * @return 0 on success.
 */
static int prepare_reservations(
    size_t total_regions,
    sel4utils_elf_region_t regions[total_regions])
{
 ...
 */
static int compare_regions(
    sel4utils_elf_region_t a,
    sel4utils_elf_region_t b)
{
...
void *sel4utils_elf_load_record_regions(
    vspace_t *loadee,
    vspace_t *loader,
    vka_t *loadee_vka,
    vka_t *loader_vka,
